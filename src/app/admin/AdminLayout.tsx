...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1117] flex flex-col">
        ...
        <header className="fixed top-0 inset-x-0 z-50 bg-[#1a1d27]/95 backdrop-blur-xl border-b border-white/5">
          <div className="max-w-7xl mx-auto h-16 px-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-red-500/20 text-red-400 border border-red-500/20">
                Super Admin
              </span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 text-xs font-semibold text-white/40 hover:text-red-400 transition-colors"
              >
      ...
      <main
        className={`flex-1 ${
          !isLogin ? "pt-16 pb-20 md:pb-0" : ""
        } max-w-7xl mx-auto w-full px-4`}
      >
        <Outlet />
      </main>
