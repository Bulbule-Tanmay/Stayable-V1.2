...
export const getStudentEnquiries = () => req<any[]>("/enquiries")
...
export const startOwnerTrial = (plan_id: string) =>
  req<any>("/owner/subscription/trial", {
    method: "POST",
    body: JSON.stringify({ plan_id }),
  })

export const createRazorpayOrder = (plan_id: string) =>
  req<any>("/owner/subscription/create-order", {
    method: "POST",
    body: JSON.stringify({ plan_id }),
  })
...
export const verifyRazorpayPayment = (payload: {
  ...
  req<any>("/owner/subscription/verify-payment", {
    method: "POST",
...
export const updateProfile = (body: any) =>
  req<any>("/profile", { method: "PUT", body: JSON.stringify(body) })
...
export const adminApproveListing = (id: string, approved: boolean) =>
  req<any>(`/admin/listings/${id}/approve`, {
    method: "PUT",
